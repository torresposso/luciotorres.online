<footer class="content-info bg-primary text-slate-400 border-t border-white/10 py-12 px-6 text-center">
    <div class="max-w-7xl mx-auto w-full flex flex-col items-center gap-6">
        ...
        <p class="text-sm text-slate-400 max-w-md leading-relaxed font-sans">
