...
<div class="fab" data-share-container>
  ...
  <div class="relative flex items-center justify-center z-50 size-[72px]">
    ...
    <div tabindex="0" role="button" class="btn btn-lg btn-circle btn-secondary rounded-full shadow-xl hover:rotate-12 hover:scale-105 transition-all duration-300 flex items-center justify-center size-16" aria-label="{{ __('Compartir artículo', 'luciotorres') }}">
  ...
  <button type="button"
          ...
          data-tip="{{ __('Copiar enlace', 'luciotorres') }}"
          aria-label="{{ __('Copiar enlace del artículo', 'luciotorres') }}">
  ...
  <a href="https://api.whatsapp.com/send?text={{ $encodedTitle }}%20{{ $encodedUrl }}"
     ...
     data-tip="{{ __('WhatsApp', 'luciotorres') }}"
     aria-label="{{ __('Compartir en WhatsApp', 'luciotorres') }}">
  ...
  <a href="https://www.facebook.com/sharer/sharer.php?u={{ $encodedUrl }}"
     ...
     rel="noopener noreferrer"
     class="btn btn-circle rounded-full fab-sub-button shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center tooltip tooltip-left size-16 mx-auto"
     data-tip="{{ __('Facebook', 'luciotorres') }}"
     aria-label="{{ __('Compartir en Facebook', 'luciotorres') }}">
    <svg class="size-6 fill-current" viewBox="0 0 24 24">
  ...
  <a href="https://twitter.com/intent/tweet?url={{ $encodedUrl }}&text={{ $encodedTitle }}"
     ...
     rel="noopener noreferrer"
     class="btn btn-circle rounded-full fab-sub-button shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center tooltip tooltip-left size-16 mx-auto"
     data-tip="{{ __('Twitter / X', 'luciotorres') }}"
     aria-label="{{ __('Compartir en Twitter', 'luciotorres') }}">
    <svg class="size-6 fill-current" viewBox="0 0 24 24">
