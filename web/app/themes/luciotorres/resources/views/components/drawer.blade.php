    ...
    <div
        ...
        <div class="flex flex-col gap-8">
            ...
            <form role="search" method="get" action="{{ home_url('/') }}"
                class="flex items-center bg-white/5 border border-white/10 rounded-2xl px-4 py-2 text-white gap-2 w-full focus-within:border-secondary/50 transition-colors">
            ...
            @if (has_nav_menu('primary_navigation'))
                <nav class="w-full flex flex-col items-center" aria-label="Mobile Navigation">
                    {!! wp_nav_menu([
                        ...
                        'menu_class' =>
                            'menu menu-vertical items-center text-center text-xl font-display font-bold gap-4 text-white/90 w-full [&_li]:flex [&_li]:justify-center [&_li]:items-center [&_li]:w-full [&_a]:relative [&_a]:inline-flex [&_a]:justify-center [&_a]:items-center [&_a]:text-center [&_a]:w-auto [&_a]:px-4 [&_a]:py-2 [&_a]:transition-all [&_a]:duration-300 [&_a:hover]:text-secondary [&_a:hover]:bg-transparent [&_a:hover]:scale-[1.06] [&_a::after]:content-[\'\'] [&_a::after]:absolute [&_a::after]:bottom-[-2px] [&_a::after]:left-1/4 [&_a::after]:w-1/2 [&_a::after]:h-[2px] [&_a::after]:bg-secondary [&_a::after]:scale-x-0 [&_a::after]:origin-center [&_a::after]:transition-transform [&_a::after]:duration-300 [&_a:hover::after]:scale-x-100',
                        'container' => false,
                        'echo' => false,
                    ]) !!}
                </nav>
        ...
        <div class="mt-auto border-t border-white/10 pt-6 flex flex-col gap-6">
            <div class="flex gap-5 items-center justify-center">
                ...
                <a href="https://www.youtube.com/@EdisonLucioTorres" target="_blank"
                    class="text-white/60 hover:text-secondary hover:-translate-y-1 transition-all duration-300" aria-label="YouTube">
                ...
                <a href="https://twitter.com/luciotorres_o" target="_blank"
                    class="text-white/60 hover:text-secondary hover:-translate-y-1 transition-all duration-300" aria-label="X (Twitter)">
                ...
                <a href="https://www.facebook.com/edisonluciotorres" target="_blank"
                    class="text-white/60 hover:text-secondary hover:-translate-y-1 transition-all duration-300" aria-label="Facebook">
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        <path
