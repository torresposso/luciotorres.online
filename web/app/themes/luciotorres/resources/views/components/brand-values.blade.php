...
<section class="relative bg-base-100 py-16 lg:py-24 overflow-hidden border-b border-base-300" id="valores" aria-labelledby="valores-heading">
  ...
  <div class="max-w-6xl mx-auto px-4 relative z-10 space-y-12">
    ...
    <div class="space-y-3 animate-fade-in-up">
      <span class="font-sans text-[10px] font-extrabold uppercase tracking-[0.25em] text-secondary">{{ __('Nuestros Pilares', 'luciotorres') }}</span>
      <h2 id="valores-heading" class="font-display text-3xl lg:text-4xl font-extrabold text-primary tracking-tight">{{ __('Valores Fundamentales', 'luciotorres') }}</h2>
      <p class="font-serif text-sm text-base-content/70 max-w-xl leading-relaxed">
        {{ __('Los principios inquebrantables que guían cada investigación, análisis y opinión producida por nuestra redacción.', 'luciotorres') }}
      </p>
    </div>
