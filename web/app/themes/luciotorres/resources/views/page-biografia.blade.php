...
@section('content')
    @while (have_posts())
        ...
        <section
            ...
            <div
                class="absolute top-0 right-0 w-[600px] h-[600px] bg-secondary/5 rounded-full blur-[80px] pointer-events-none">
            </div>
            <div
            ...
            <div class="max-w-7xl mx-auto w-full relative z-10 grid md:grid-cols-12 gap-10 md:gap-14 items-center">
                <div class="md:col-span-7 flex flex-col gap-6 reveal">
                    ...
                    <h1
                        class="text-4xl md:text-5xl lg:text-7xl font-display font-black text-white leading-[0.95] text-balance">
                        Sobre Lucio
                    </h1>
                    <p class="text-primary-content/85 text-base md:text-lg leading-relaxed font-sans max-w-2xl">
                        <strong>Edison Lucio Torres</strong> (Magangué, Bolívar, Colombia, 13 de diciembre de 1959) is un
                        comunicador social, periodista y escritor colombiano, defensor y docente universitario de Derechos
                        Humanos.
                        Fue, junto a Carlos Gaviria y a Gustavo Petro, uno de los precandidatos inscritos de cara a las
                        elecciones
                ...
                <div class="md:col-span-5 flex justify-center md:justify-end reveal reveal-delay-200">
                    <div class="relative group max-w-sm w-full">
                        ...
                        <img src="/app/uploads/2025/10/lucio-torres.png"
                            alt="Edison Lucio Torres — Periodista y escritor colombiano" width="500" height="500"
        ...
        <section
            ...
            <div class="absolute -bottom-32 -left-32 w-96 h-96 bg-secondary/5 rounded-full blur-3xl pointer-events-none">
            </div>
            <div class="max-w-7xl mx-auto w-full grid md:grid-cols-12 gap-10 md:gap-14 lg:gap-20 items-center relative">
                <div class="md:col-span-7 order-2 md:order-1 flex flex-col gap-6 reveal">
                    ...
                    <p class="text-base-content/85 leading-relaxed font-sans">
                        Perteneció a los círculos socialistas estudiantiles de finales de la década de los 70. Dirigió las
                        jornadas
                        estudiantiles de Magangué y Barranquilla. Lideró el movimiento estudiantil que luchó por el
                        mejoramiento de
                        la calidad de la educación. En septiembre fue expulsado del Liceo Vélez donde estudiaba su
                        bachillerato. En
                        1977 debió abandonar definitivamente a Magangué para radicarse en Barranquilla. Participó en el Paro
                        Cívico
                        Nacional de 1977.
                    </p>
                    <p class="text-base-content/85 leading-relaxed font-sans">
                        ...
                        en el programa de comunicación social-periodismo, donde se graduó. Trabajó en Caracol, RCN y
                        Olímpica, y en
                        diarios como El Heraldo, Diario del Caribe y La Libertad. Fue corresponsal en Barranquilla del
                        noticiero
                        <em>Promec</em>, dirigido por María Teresa Herrán. Promovió la profesionalización y los derechos de
                        los
                        periodistas.
                    </p>
                </div>
                <div class="md:col-span-5 order-1 md:order-2 flex flex-col gap-6 reveal reveal-delay-200">
                    <div class="relative group w-full">
                        <div class="relative rounded-2xl overflow-hidden shadow-premium">
                            ...
                            <img src="/app/uploads/2025/12/WhatsApp-Image-2025-11-22-at-10.56.16-AM2.jpeg"
                                alt="Edison Lucio Torres en su labor periodística" width="500" height="600"
                                loading="lazy"
                    ...
                    <div
                        ...
                        <p class="text-primary-content/70 text-sm leading-relaxed font-sans">Amplia experiencia en docencia
                            y
            ...
            <div class="max-w-4xl mx-auto w-full flex flex-col gap-12 relative">
                ...
                <div class="flex flex-col gap-6 font-sans reveal reveal-delay-200">
                    <p class="text-base-content/85 leading-relaxed text-base md:text-lg">
                        Luego se destacó en la construcción de opinión pública crítica y proactiva desde la radio
                        barranquillera. En
                        1991 impulsó activamente la consulta popular de la Ad-M19 para escoger como candidato a la alcaldía
                        de
                        ...
                        <a href="https://es.wikipedia.org/wiki/Bernardo_Hoyos_Montoya" title="Bernardo Hoyos Montoya"
                            ...
                            Hoyos Montoya</a>.
                        Fue uno de los fundadores del Movimiento Ciudadano. En 1996 fue candidato al senado pero renunció
                        para apoyar
                        a Laura García Vda. de Pizarro.
                    </p>
                    <p class="text-base-content/85 leading-relaxed text-base md:text-lg">
                        En el 2001, luego de sentirse frustrado por el proyecto político de Barranquilla, regresó a
                        Cartagena. Cursó
                        Altos Estudios en derechos humanos, historia nacional y la especialización en periodismo de
                        investigación con
                        la Universidad de Antioquia y Universidad Nacional. En la heroica está desarrollando una lucha por
                        los
                        ...
                        decidió promover su campaña como precandidato presidencial de la República de Colombia para las
                        consultas
                ...
                <div class="flex justify-center pt-4 reveal reveal-delay-300">
                    <a href="{{ home_url('/') }}"
                        ...
                        <span
                            class="inline-block transform group-hover/link:-translate-x-1.5 transition-transform duration-300 will-change-transform"
