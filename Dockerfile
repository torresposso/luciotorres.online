...
WORKDIR /theme
COPY web/app/themes/luciotorres/package*.json ./
RUN npm ci
...
COPY web/app/themes/luciotorres/ .
RUN npm run build
...
COPY web/app/themes/luciotorres/composer.json ./web/app/themes/luciotorres/
...
RUN cd web/app/themes/luciotorres && \
    composer install \
    --no-dev \
    --no-interaction \
    --optimize-autoloader
...
COPY --from=vendor /app/web/app/themes/luciotorres/vendor /app/web/app/themes/luciotorres/vendor
COPY --from=build /theme/public /app/web/app/themes/luciotorres/public
